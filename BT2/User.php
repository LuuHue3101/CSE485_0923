    ...
    <div class="Container">
        ...
        <div class="Main">
            <div class="Main_Header">
                            ...
                            <?php
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo'<form method="POST" action="User_Delete.php" style="transform: translateX(255%);">
                                        ...
                                        <a href="" data-bs-taggle="modal"  data-bs-target="<?= $user[0];?>"><button name="delete_button" type="submit" style="background-color:orangered;border:none;border-radius:5px;margin:2px"><i style="color:white" class="bi bi-trash3"></i></button>
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" id="xampleModal"">
               ...
               <li class="page-item active" style="margin-top:20px" aria-current="page">
                   <span class="page-link">1<span class="sr-only"></span></span>
               </li>
               <!-- Các liên kết chuyển trang sẽ được thêm ở đây -->
               <li class="page-item" style="margin-top:20px"><a class="page-link" href="Next_page.php">2</a></li>
